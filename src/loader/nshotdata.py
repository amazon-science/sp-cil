...
def get_nshot_data(dataset, nshot=0, seed=None):
...
def NshotDataLoader(cfg, splits, batch_size, seed=None):
    ...
    for split in splits:
        ...
        if split == "train":
            dataset = data.Subset(dataset, get_nshot_data(dataset, nshot=cfg["n_shot"], seed=seed))
